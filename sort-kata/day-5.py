...
class BubbleSortTest(unittest.TestCase):
    ...
    def test_sorts_a_sinlge_element_list(self):
    ...
    def test_sorts_a_2_1_3_list(self):
        self.assertEqual([1, 2, 3], bubble_sort([2, 1, 3]))

    def test_sorts_a_3_1_2_list(self):
        self.assertEqual([1, 2, 3], bubble_sort([3, 1, 2]))

    def test_sortsa_3_2_1_list(self):
...
class QuickSortTest(unittest.TestCase):
    ...
    def test_sorts_a_1_3_s2_list(self):
